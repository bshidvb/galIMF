...
def write_data():
    ...
    if make_dir == True:
        os.makedirs('yield_tables__2024/rearranged___/setllar_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_lifetime_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Mfinal_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_H_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_He_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_C_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_C13_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_N_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_O_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_O17_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_O18_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Ne_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Na_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Mg_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Al_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Si_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_S_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Ar_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Ca_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Ti_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Cr_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Mn_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Fe_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Ni_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
        os.makedirs('yield_tables__2024/rearranged___/setllar_Y_eject_mass_from_{}'.format(yield_table_name), exist_ok=True)
    ...
    for Z in range(len(Z_extrapolation_list)):
        ...
        name_eject_mass = 'yield_tables__2024/rearranged___/setllar_eject_mass_from_{}/{}_Z={}.txt'.format(yield_table_name,
                                                                                                     yield_table_name,
                                                                                                     metallicity)
        ...
        # name_lifetime = 'yield_tables__2024/rearranged___/setllar_lifetime_from_{}/{}_Z={}.txt'.format(yield_table_name,
        #                                                                                              yield_table_name,
        #                                                                                              metallicity)
        ...
        name_Mfinal = 'yield_tables__2024/rearranged___/setllar_Mfinal_from_{}/{}_Z={}.txt'.format(yield_table_name,
                                                                                                     yield_table_name,
                                                                                                     metallicity)
        ...
        name_H_eject_mass = 'yield_tables__2024/rearranged___/setllar_H_eject_mass_from_{}/{}_Z={}.txt'.format(
        ...
        # for n in range(len(p30)):
        #     out_H_eject_mass += '{} '.format(p30[n])
        name_He_eject_mass = 'yield_tables__2024/rearranged___/setllar_He_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_C_eject_mass = 'yield_tables__2024/rearranged___/setllar_C_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_C13_eject_mass = 'yield_tables__2024/rearranged___/setllar_C13_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_N_eject_mass = 'yield_tables__2024/rearranged___/setllar_N_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_O_eject_mass = 'yield_tables__2024/rearranged___/setllar_O_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_O17_eject_mass = 'yield_tables__2024/rearranged___/setllar_O17_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_O18_eject_mass = 'yield_tables__2024/rearranged___/setllar_O18_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Ne_eject_mass = 'yield_tables__2024/rearranged___/setllar_Ne_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Na_eject_mass = 'yield_tables__2024/rearranged___/setllar_Na_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Mg_eject_mass = 'yield_tables__2024/rearranged___/setllar_Mg_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Al_eject_mass = 'yield_tables__2024/rearranged___/setllar_Al_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Si_eject_mass = 'yield_tables__2024/rearranged___/setllar_Si_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_S_eject_mass = 'yield_tables__2024/rearranged___/setllar_S_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Ar_eject_mass = 'yield_tables__2024/rearranged___/setllar_Ar_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Ca_eject_mass = 'yield_tables__2024/rearranged___/setllar_Ca_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Ti_eject_mass = 'yield_tables__2024/rearranged___/setllar_Ti_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Cr_eject_mass = 'yield_tables__2024/rearranged___/setllar_Cr_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Mn_eject_mass = 'yield_tables__2024/rearranged___/setllar_Mn_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Ni_eject_mass = 'yield_tables__2024/rearranged___/setllar_Ni_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Fe_eject_mass = 'yield_tables__2024/rearranged___/setllar_Fe_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
        ...
        name_Metal_eject_mass = 'yield_tables__2024/rearranged___/setllar_Metal_eject_mass_from_{}/{}_Z={}.txt'.format(
            yield_table_name, yield_table_name, metallicity)
    ...
    print('yield_tables__2024/rearranged___/setllar_...eject_mass_from_{}/{}_Z=....txt saved'.format(yield_table_name,
                                                                                               yield_table_name))
    return
...
if __name__ == '__main__':
    ...
    Mn_over_Fe_list = []
    Ni_over_Fe_list = []
    yield_table_name = "K10_K06_HNe00"  # "K10_K06_HNe10" or "C15_N13_HNe10" or "WW95" or "portinari98" or "marigo01" or "Kobayashi06" or "Karakas10"
