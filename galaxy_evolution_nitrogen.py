...
Log_SFR_list = [1]      # 15, 30,  50, 100
SFEN_list = [60]       # Example values
STF_list = [0.04]
SFE_list = [0.9e-3, 1e-3]
        ...
        for STF in STF_list:
            for SFE in SFE_list:
                ...
                galevo.galaxy_evol(imf='Kroupa', STF=STF, SFEN=SFEN, Z_0=1e-6, solar_mass_component="Asplund2009_mass",
                                ...
                                high_time_resolution=None, plot_show=None, plot_save=None, outflow=200, check_igimf=None, tau_infalle9=0.01)
