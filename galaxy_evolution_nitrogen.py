...
Log_SFR_list = [-0.3]  # 20 M_sun/yr (Tacchella et al. 2023)
SFEN_list = [30]       # 70 ± 40 Myr (Tacchella et al. 2023)
STF_list = [0.04]
SFE_list = [0.009]
tau_infall_list = [0.0002]
            ...
            for SFE in SFE_list:
                for tau_infall in tau_infall_list:
                    ...
                    galevo.galaxy_evol(imf='Kroupa', STF=STF, SFEN=SFEN, Z_0=1e-6, solar_mass_component="Asplund2009_mass",
                                    str_yield_table='Limongi_M300', IMF_name='Kroupa', steller_mass_upper_bound=150, #try 100
                                    ...
                                    high_time_resolution=None, plot_show=None, plot_save=True, outflow=70, check_igimf=None, tau_infalle9=tau_infall)
