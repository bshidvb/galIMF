        ...
        for STF in STF_list:
            for SFE in SFE_list:
                ...
                galevo.galaxy_evol(imf='Kroupa', STF=STF, SFEN=SFEN, Z_0=1e-6, solar_mass_component="Asplund2009_mass",
                                str_yield_table='Limongi_R300', IMF_name='Kroupa', steller_mass_upper_bound=20,
                                ...
                                high_time_resolution=None, plot_show=None, plot_save=None, outflow=100, check_igimf=None, tau_infalle9=0.01)
