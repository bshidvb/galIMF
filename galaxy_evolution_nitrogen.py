...
Log_SFR_list = [0.2]   # 20 M_sun/yr (Tacchella et al. 2023)
SFEN_list = [15]       # 70 ± 40 Myr (Tacchella et al. 2023)
STF_list = [0.04]
SFE_list = [0.006]
tau_infall_list = [0.0085]
location = 10
skewness = 0
sfr_tail = 0
            ...
            for SFE in SFE_list:
                for tau_infall in tau_infall_list:
                    ...
                    galevo.galaxy_evol(imf='Kroupa', STF=STF, SFEN=SFEN, Z_0=1e-6, solar_mass_component="Asplund2009_mass",
                                    str_yield_table='Nomoto_sup_agb', IMF_name='Kroupa', steller_mass_upper_bound=150, #try 100
                                    ...
                                    high_time_resolution=None, plot_show=None, plot_save=True, outflow=120, check_igimf=None, tau_infalle9=tau_infall)

# variable imf for n13 model 
# Log_SFR_list = [1.0]   # 20 M_sun/yr (Tacchella et al. 2023)
# SFEN_list = [100]       # 70 ± 40 Myr (Tacchella et al. 2023)
# STF_list = [0.04]
# SFE_list = [0.008]
# tau_infall_list = [0.0065]
...
#                 for tau_infall in tau_infall_list:
#                     galevo.generate_SFH('flat',  Log_SFR, SFEN, sfr_tail, skewness, location)
#                     galevo.galaxy_evol(imf='igimf', STF=STF, SFEN=SFEN, Z_0=1e-6, solar_mass_component="Asplund2009_mass",
#                                     str_yield_table='Nomoto_sup_agb', IMF_name='Kroupa', steller_mass_upper_bound=150, #try 100
#                                     time_resolution_in_Myr=1, mass_boundary_observe_low=1.5, mass_boundary_observe_up=8,
#                                     SFH_model='gas_mass_dependent', SFE=SFE, SNIa_ON=True, SNIa_yield_table='Iwamoto1999',
#                                     solar_abu_table='Asplund2009',
#                                     high_time_resolution=None, plot_show=None, plot_save=True, outflow=110, check_igimf=None, tau_infalle9=tau_infall)
