...
galevo.galaxy_evol(imf='Kroupa', STF=0.15, SFEN=SFEN, Z_0=1e-6, solar_mass_component="Asplund2009_mass",
                ...
                high_time_resolution=None, plot_show=None, plot_save=None, outflow=500, check_igimf=None)
