...
Log_SFR_list = [1.38]      # 15, 30,  50, 100
SFEN_list = [8]       # Example values
STF_list = [0.04]        # Example values
SFE_list = [0.075]
    ...
    for Log_SFR in Log_SFR_list:
        for STF in STF_list:
            for SFE in SFE_list:
                ...
                galevo.galaxy_evol(imf='Kroupa', STF=STF, SFEN=SFEN, Z_0=0.1, solar_mass_component="Asplund2009_mass",
                                str_yield_table='Limongi_R300', IMF_name='Kroupa', steller_mass_upper_bound=10,
                                ...
                                high_time_resolution=None, plot_show=None, plot_save=None, outflow=0, check_igimf=None, tau_infalle9=0.01)
